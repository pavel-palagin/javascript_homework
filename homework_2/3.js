...
// 1-я декада - с 1 по 10 числа месяца; 2-я декада - с 11 по 20 числа месяца; 3-я декада - с 21 по последнее число месяца.
...
if (dayNumber >= 1 && dayNumber < 11) {
  ...
  alert(`Число ${dayNumber} попадает в 2-ю декаду месяца.`);
